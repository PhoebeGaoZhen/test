...
num_negative = 2046
path_network_name_type = 'DATA\\traindataEcoli\\Ecoli_GRN_3types.csv'
path_expression = 'DATA\\traindataEcoli\\final_Ecoli_oxidative.csv'
...
network_dict_name = 'Ecoli_oxidative'      # 不同网络
